...
#### Cache
- [x] Сервис для кеширования
- [x] Поддержка локального кеша (в памяти)
- [x] Поддержка Redis для шаренного хранилища
- [x] Гибкое управление TTL

#### HTTP
- [x] Возможность генерации типизированного клиента для вызова своих эндпоинтов
...
#### Validation
- [x] Типизированная стандартизированная валидация входящих и выходящих данных
- [x] Устранение дублирования кода для валидации, типов и сваггер-документации

#### Swagger
- [x] Автоматический сбор сваггер-документации на основе типов и декораторов

### Modules
- [x] Drizzle ORM (sqlite, postgres)
  - [ ] timescale db
...
- [x] modules app: приложение с динамическим запуском модулей
